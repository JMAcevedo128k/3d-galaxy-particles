...
import { PointsMaterial } from "https://cdn.skypack.dev/three@0.136.0";
console.clear();
...
// Ajusta los valores iniciales directamente en el código
const u = galaxyMaterial.uniforms;

u.uSize.value = 0.8; // Valor inicial para el tamaño de las estrellas
u.uBranches.value = 2; // Número de ramas
u.uRadius.value = 0; // Escala inicial
u.uSpin.value = Math.PI * 0.25; // Giro inicial
u.uRandomness.value = 0; // Dispersión inicial
u.uColorInn.value.set("#9483af"); // Color interior
u.uColorOut.value.set("#3243a6"); // Color exterior
...
.onComplete(() => {
  // Mostrar el botón al finalizar la animación
...
function figuraMouse() {
  // Crear nueva geometría para el punto del mouse
  // Agregar evento de movimiento del mouse al canvas
